...
<head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Nanum+Gothic|Open+Sans|Poor+Story" rel="stylesheet">
...
<body class="white-content">
  ...
  <div class="col-md-12">
    ...
    <h1 class="store" style="text-align: left; margin-left: 21px; margin-bottom: 10px; border: 0; font-family: 'Nanum Gothic', sans-serif; text-decoration: none;"></h1>
    <img class="main-junc" alt="main-pos-icon" src="imgs/main-pos.png" style="max-width: 8%; position: absolute;top: 0px;left: 777px">
    <h4 class="owner_and_phone" style="text-align: left; margin-left: 21px; border: 0; font-family: 'Nanum Gothic', sans-serif; text-decoration: overline; margin-top: 10px"></h4>
  </div>
  <div class="row">
    <!-- 차트부분 -->
