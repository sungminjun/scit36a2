				...
				<div class="row">
					<div class="col-md-12">
						<div class="card">
							<div class="card-body">
								<div class="row">
									<button class="btn ml-auto mr-auto" id="mgr-btn-1">지출내역
										관리</button>
									<button class="btn ml-auto mr-auto" id="mgr-btn-2">판매메뉴
										관리</button>
									<button class="btn ml-auto mr-auto" id="mgr-btn-3">점내좌석
										관리</button>
									<button class="btn ml-auto mr-auto" id="mgr-btn-4">업체정보
										관리</button>
									<button class="btn ml-auto mr-auto" id="mgr-btn-5">영업마감
										취소</button>
								</div>
							</div>
							<!-- 
										...
										<div class="row">
											...
											<div class="col-md-8">
												<div class="form-group">
													<label>유형</label> <select class="form-control" id="mgr-1-1"
														name="expense_type">
											...
											<div class="col-md-8">
												<div class="form-group">
													<label>날짜</label> <input type="date" class="form-control"
														id="mgr-1-2" name="expense_date">
												</div>
											</div>
											<div class="col-md-4">난까노 유효성검사 _js_ will be placed
												here.</div>
											<div class="col-md-8">
												<div class="form-group">
													<label>설명</label> <input type="text" class="form-control"
														id="mgr-1-3" name="expense_description">
												</div>
											</div>
											<div class="col-md-4">난까노 유효성검사 _js_ will be placed
												here.</div>
											<div class="col-md-8">
												<div class="form-group">
													<label>금액</label> <input type="text" class="form-control"
														id="mgr-1-4" name="expense_amount">
												</div>
											</div>
											<div class="col-md-4">난까노 유효성검사 _js_ will be placed
												here.</div>
											<div class="col-md-8">
												<div class="form-group">
													<button class="btn-default pull-right justify-content-end"
														id="mgr-btn-1-5" style="display: flex;">등록</button>
													<button class="btn-default pull-right justify-content-end"
														id="mgr-btn-1-6" style="display: none;">수정</button>
													<button class="btn-default pull-right justify-content-end"
														id="mgr-btn-1-7" style="display: none;">삭제</button>
												</div>
											</div>
									...
									<div class="col-md-6">
										<div class="row">
											<div class="col-md-8 input-group">
												<label>해당월</label> <input type="text" id="datepicker_exp"
													class="form-control text-center" placeholder="YYYY-MM">
...
-->
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="row">
											...
											<div class="col-md-8">
												<div class="form-group">
													<label>분류</label> <input type="text" class="form-control"
														id="mgr-2-1" name="menu_category"
														placeholder="e.g. 식사, 주류, 요리">
												</div>
											</div>
											<div class="col-md-4">길이제한 유효성검사 _js_ will be placed
												here.</div>

											<div class="col-md-8">
												<div class="form-group">
													<label>이름</label> <input type="text" class="form-control"
														id="mgr-2-2" name="menu_name"
														placeholder="e.g. 짜장면, 짬뽕, 탕수육">
												</div>
											</div>
											<div class="col-md-4">길이제한 유효성검사 _js_ will be placed
												here.</div>
											...
											<div class="col-md-8">
												<div class="form-group">
													<label>가격</label> <input type="text" class="form-control"
														id="mgr-2-3" name="menu_price" placeholder="가격을 입력하세요.">
												</div>
											</div>
											<div class="col-md-4">길이제한 유효성검사 _js_ will be placed
												here.</div>
											...
											<div class="col-md-8">
												<div class="form-group">
													<label>판매중</label> <select class="form-control"
														id="mgr-2-4" name="menu_sellFlag">
											...
											<div class="col-md-8">
												<div class="form-group">
													<button class="btn-default pull-right justify-content-end"
														id="mgr-btn-2-5" style="display: flex;">등록</button>
													<button class="btn-default pull-right justify-content-end"
														id="mgr-btn-2-6" style="display: none;">수정</button>
													<button class="btn-default pull-right justify-content-end"
														id="mgr-btn-2-7" style="display: none;">삭제</button>
												</div>
											</div>
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="row">
									<div class="col-md-3">
										<div class="form-group">
											<input type="text" class="form-control" id="mgr-3-1" value=""
												disabled="disabled">
										</div>
									</div>
									<div class="col-md-2">
										<div class="form-group">
											<input type="text" class="form-control" id="mgr-3-2" value=""
												disabled="disabled">
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
											<input type="text" class="form-control" id="mgr-3-3"
												placeholder="등록할 테이블 이름" name="seat_id">
										</div>
									</div>
									<div class="col-md-2">
										<div class="form-group">
											<button class="btn-default" id="mgr-btn-3-4">등록</button>
											<button class="btn-default" id="mgr-btn-3-5"
												style="display: none;">수정</button>
										</div>
									</div>
									<div class="col-md-2">
										<div class="form-group">
											<button class="btn-default" id="mgr-btn-3-6"
								...
								<div class="row">
									<div class="col-md-6" id="mgr-3-6"></div>
								</div>
				...
				<div class="row mgr-4" style="display: none;">
					<div class="col-md-12">
						<div class="card">
							...
							<div class="card-body">
								<div class="row">
									<button class="btn ml-auto mr-auto" id="mgr-btn-4-1">업체정보
										관리</button>
									<button class="btn ml-auto mr-auto" id="mgr-btn-4-2">본인계정
										관리</button>
									<button class="btn ml-auto mr-auto" id="mgr-btn-4-3">직원계정
										관리</button>
								</div>
							</div>
						</div>
					...
					<div class="col-md-12">
									...
									<form id="mgr-4-1-form" action="updateCompany" method="POST">
										<div class="col-md-12">
											<div class="row">
												<div class="col-md-8">
													<div class="form-group">
														<label>사업자등록번호</label> <input type="text"
															class="form-control" id="mgr-4-1-comp_id" name="comp_id"
															readonly="readonly">
													</div>
												</div>
												<div class="col-md-8">
													<div class="form-group">
														<label>가게이름</label> <input type="text"
															class="form-control" id="mgr-4-1-comp_name"
															name="comp_name">
													</div>
												</div>
												<div class="col-md-4">길이제한 유효성검사 _js_ will be placed
												...
												<div class="col-md-8">
													<div class="form-group">
														<label>가게전화번호</label> <input type="text"
															class="form-control" id="mgr-4-1-comp_tel"
															name="comp_tel">
													</div>
												</div>
												<div class="col-md-4">길이제한 유효성검사 _js_ will be placed
												...
												<div class="col-md-8">
													<div class="form-group">
														<label for="comp_address">주소</label> <input type="text"
															class="form-control" name="comp_address"
															id="search_button" value="">
													</div>
												</div>
												<div class="col-md-8">
													<div class="form-group">
                        ...
                        <input type="text" class="form-control" name="comp_address2">
												...
												<div class="col-md-8">
													<div class="form-group">
														<input type="submit"
															class="btn-default pull-right justify-content-end"
															value="수정">
													</div>
												</div>
									...
									<form id="mgr-4-2-form" action="updateOwner" method="POST">
										<div class="col-md-12">
											<div class="row">
												<div class="col-md-8">
													<div class="form-group">
														<label>사장ID</label> <input type="text"
															class="form-control" id="mgr-4-2-emp_id" name="emp_id"
															readonly="readonly">
													</div>
												</div>
												<div class="col-md-8">
													<div class="form-group">
														<label>이름</label> <input type="text" class="form-control"
															id="mgr-4-2-emp_name" name="emp_name">
													</div>
												</div>
												<div class="col-md-4">난또까노 유효성검사 _js_ will be placed
													here.</div>

												<div class="col-md-8">
													<div class="form-group">
														<label>비밀번호</label> <input type="password"
															class="form-control" id="mgr-4-2-emp_pw" name="emp_pw">
													</div>
												</div>
												<div class="col-md-4">*정보수정을 위해서는 최소한 비밀번호가 입력되어야 한다.
													난또까노 유효성검사 _js_ will be placed here.</div>

												<div class="col-md-8">
													<div class="form-group">
														<label>새로운 비밀번호</label> <input type="password"
															class="form-control" id="mgr-4-2-emp_new_pw"
															name="emp_new_pw">
													</div>
												</div>
												<div class="col-md-4">*비밀번호 변경을 위해서는 검사를 거쳐야 한다. 비밀번호
													doublecheck _js_ will be placed here.</div>

												<div class="col-md-8">
													<div class="form-group">
														<label>비밀번호 확인</label> <input type="password"
															class="form-control" id="mgr-4-2-emp_new_pw2"
															name="emp_new_pw2">
													</div>
												</div>
												<div class="col-md-4">*비밀번호 변경을 위해서는 검사를 거쳐야 한다. 비밀번호
												...
												<div class="col-md-8">
													<div class="form-group">
														<label>전화번호</label> <input type="text"
															class="form-control" id="mgr-4-2-emp_tel" name="emp_tel">
													</div>
												</div>
												<div class="col-md-4">난또까노 유효성검사 _js_ will be placed
													here.</div>
								...
								<div class="row mgr-4-3" style="display: none;">
									...
									<div class="col-md-6">
										<div class="card" id="infomng">직원관리</div>
											...
											<div class="col-md-12">
												<div class="row">
													...
													<div class="col-md-8">
														<div class="form-group">
															<label>비밀번호</label> <input type="password"
																class="form-control" id="mgr-4-3-emp_pw" name="emp_pw">
														</div>
													</div>
													<div class="col-md-4">난또까노 유효성검사 _js_ will be placed
														here.</div>
													...
													<div class="col-md-8">
														<div class="form-group">
															<label>비밀번호 확인</label> <input type="password"
																class="form-control" id="mgr-4-3-emp_pw2" name="emp_pw2">
														</div>
													</div>
													<div class="col-md-4">비밀번호 doublecheck _js_ will be
														placed here.</div>

													<div class="col-md-8">
														<div class="form-group">
															<label>이름</label> <input type="text" class="form-control"
																id="mgr-4-3-emp_name" name="emp_name">
														</div>
													</div>
													<div class="col-md-4">난또까노 유효성검사 _js_ will be placed
														here.</div>
													...
													<div class="col-md-8">
														<div class="form-group">
															<label>전화번호</label> <input type="text"
																class="form-control" id="mgr-4-3-emp_tel" name="emp_tel">
														</div>
													</div>
													<div class="col-md-4">난또까노 유효성검사 _js_ will be placed
														here.</div>
													...
													<div class="col-md-8">
														<div class="form-group">
															<input type="submit"
																class="btn-default pull-right justify-content-end"
																id="mgr-4-3-btn-submit" value="등록">
														</div>
													</div>
	...
	<script>
		...
		function mgrshow(param) {
			...
			if (param == 4)
				$('.mgr-4').css('display', 'flex');
			else
				$('.mgr-4').css('display', 'none');
														...
														.each(
																...
																function(idx,
																	...
																	if (obj == obj2.menu_category) {
																		output2 += '<button class="btn-secondary" s-menuseq="' + obj2.menu_seq + '" s-menu-regex="' + obj + '|' + obj2.menu_name + '|' + obj2.menu_price + '|' + obj2.menu_sellFlag + '">'
																				+ obj2.menu_name
																				+ '<br>'
																				+ obj2.menu_price
																				+ '<br>'
		...
		function selectmenu() {
			...
			console.log(menu_seq + ', ' + menu + ', ' + menuarr[0] + ', '
					+ menuarr[1] + ', ' + menuarr[2] + ', ' + menuarr[3]);
							...
							$
									.each(
											...
											function(idx, obj) {
												...
												output += '<button class="btn-default seatseq" style="width: ' + size + '; height:' + size + '; margin: 5px;" s-seatseq=' + obj.seat_seq + '>'
														+ obj.seat_id
														+ '</button>'
											});
			...
			if (param == 2) {
				...
				$.ajax({
					...
					success : function(resp) {
						...
						$('#mgr-4-2-emp_pw').attr('placeholder',
								'정보를 수정하시려면 비밀번호를 입력하십시오.');
						$('#mgr-4-2-emp_new_pw').attr('placeholder',
								'비밀번호를 확인하십시오.');
						$('#mgr-4-2-emp_new_pw2').attr('placeholder',
								'비밀번호를 확인하십시오.');
					}
				});
			} else {
				...
				$.ajax({
					...
					success : function(resp) {
						...
						$.each(resp, function(idx, obj) {
							...
							output += '<td class="text-center">' + obj.emp_id
		...
		function callModifyMember() {
			...
			$.ajax({
				...
				success : function(resp) {
					console.log(resp);
					$('#mgr-4-3-emp_id').val(resp.emp_id).attr('readonly',
							'readonly');
					$('#mgr-4-3-emp_name').val(resp.emp_name);
					$('#mgr-4-3-emp_tel').val(resp.emp_tel);
					$('#mgr-4-3-emp_pw').val(resp.emp_pw);
					$('#mgr-4-3-emp_pw2').attr('placeholder',
							'수정하려면 새로운 비밀번호를 입력하십시오.');
				...
				success : function(resp) {
					...
					$.each(resp, function(idx, obj) {
						...
						if (obj.cashonhand_type == 4)
							str = obj.cashonhand_register + '님이 '
									+ obj.cashonhand_regdate
									+ '에 등록한 마감정보(마감금액: ' + obj.cashonhand_cash
									+ ', 오차금액' + obj.cashonhand_error
									+ ')를 삭제하시고 마감을 취소하시겠습니까?';
						senddata = {
