  ...
  <div class="wrapper">
    <div class="sidebar" data="blue">
      <div class="sidebar-wrapper">
        ...
        <ul class="nav">
          <li><a href="posMain"> <i class="tim-icons icon-money-coins" title="포스 / Enter POS"></i>
            </a> <br> <br></li>
            ...
            <div class="card">
              <div class="card-body">
                <p style="size: 20em;">
                  ...
                  <div class="btn-group" data-toggle="buttons">
                    <label class="btn btn-secondary active"> <input type="radio" name="options" id="option1" value="day" checked> DAY
                    </label> <label class="btn btn-secondary"> <input type="radio" name="options" id="option2" value="week">
                      WEEK
                    </label> <label class="btn btn-secondary"> <input type="radio" name="options" id="option3" value="month">
                      MONTH
                    </label>
                  </div>
                  <p1>시작</p1>
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="btn-group" data-toggle="buttons">
                    <label class="btn btn-secondary active"> <input type="radio" name="options2" id="option1" checked value="sales"> 매출조회
    ...
    */
    ...
    function chartUpdate(updateData) {
      ...
      if ($('input[name=options]:checked').val() == 'day' && $('input[name=options2]:checked').val() == 'sales') {
        ...
        $('.tableTest').html(output);
        //@@@@@@@@@@@@@일 &메뉴@@@@@@@@@@@@@@   
      } else if ($('input[name=options]:checked').val() == 'day' && $('input[name=options2]:checked').val() == 'menu') {
        alert('메뉴 데이')
        //그래프 값 넣기
        $.each(updateData, function(index, item) {
          labels[temp] = item.DAYTIME;
        ...
        $('.tableTest').html(output);
        //@@@@@@@@@@@@@주 &메뉴@@@@@@@@@@@@@@
      } else if ($('input[name=options]:checked').val() == 'week' && $('input[name=options2]:checked').val() == 'menu') {
        alert('메뉴 위크')
        //그래프 값 넣기
        $.each(updateData, function(index, item) {
          labels[temp] = item.DAYTIME;
        ...
        $('.tableTest').html(output);
        //@@@@@@@@@@@@@월&메뉴@@@@@@@@@@@@@@
      } else if ($('input[name=options]:checked').val() == 'month' && $('input[name=options2]:checked').val() == 'menu') {
        alert('메뉴 먼쓰')
        //그래프 값 넣기
        $.each(updateData, function(index, item) {
          labels[temp] = item.DAYTIME;
