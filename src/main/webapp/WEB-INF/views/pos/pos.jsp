...
<body class="white-content">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-8 input-group">
                    <label>조회일자</label> <input type="text" id="datepicker_pmtlist" class="form-control text-center" placeholder="YYYY-MM-DD">
                      ...
                      <div class="modal-content bg-alert">
                        ...
                        <div id="payment_complex">
                          ...
                          <div class="row box">
                            ...
                            <div class="col-md-4 form-group mx-auto">
                              <a class="pmt_cmp_addline"><i class="tim-icons icon-simple-add text-warning"></i>한줄추가</a>
                            </div>
                          </div>
                        </div>
  ...
  <div>
    <input type="hidden" id="funcFlag" value="0"> <input type="hidden" id="tableSeqFirst" value=""> 
    <input type="hidden" id="sasSeqFirst" value=""> <input type="hidden" id="tableSeqSecond" value=""> 
    ...
    <script>
      ...
      function pos_order_discount() {
        ...
        if (temp_arr_chk == 1) { // 여기는 이미 할인금액이 있을 때
          ...
          console.log(prpt);
          if (prpt == null || prpt.length == 0) {} else {
