							...
							<form id="registForm" action="join" method="POST">
								<div class="card-body">
									<div class="row justify-content-center">
										<div class="col-md-6">
											<div class="form-group">
												<label for="comp_id">사업자 등록번호</label> <input type="text"
													class="form-control" name="comp_id">
											</div>
										</div>
									...
									<div class="row justify-content-center">
										<div class="col-md-6">
											<div class="form-group">
												<label for="comp_name">가게 이름</label> <input type="text"
													class="form-control" name="comp_name">
											</div>
										</div>
									...
									<div class="row justify-content-center">
										<div class="col-md-6">
											<div class="form-group">
												<label for="comp_tel">가게 전화번호</label> <input type="text"
													class="form-control" name="comp_tel">
											</div>
										</div>
										<div class="col-md-3"></div>
									</div>
									...
									<div class="row justify-content-center">
										<div class="col-md-6">
											<div class="form-group">
												<label for="comp_address">세부주소</label> <input type="text"
													class="form-control" name="comp_address2"> 
											</div>
										</div>
										<div class="col-md-3"></div>
									</div>
									...
									<div class="row justify-content-center">
										<div class="col-md-6">
											<div class="form-group">
												<label for="emp_id">ID</label> <input type="text"
									...
									<div class="row justify-content-center">
										<div class="col-md-6">
											<div class="form-group">
												<label for="emp_pw">PASSWORD</label> <input type="password"
													class="form-control" name="emp_pw">
											</div>
										</div>
									...
									<div class="row justify-content-center">
										<div class="col-md-6">
											<div class="form-group">
												<label for="emp_pw2">PASSWORD 재확인</label> <input
													type="password" class="form-control" name="emp_pw2">
											</div>
										</div>
									...
									<div class="row justify-content-center">
										<div class="col-md-6">
											<div class="form-group">
												<label for="emp_tel">전화번호</label> <input type="text"
													class="form-control" name="emp_tel">
											</div>
										</div>
										<div class="col-md-3"></div>
									</div>
									...
									<div class="row justify-content-center">
										<div class="col-md-6">
											<div class="form-group">
												<label for="emp_quiz_answer">비밀번호 찾기 답</label> <input
													type="text" class="form-control" name="emp_quiz_answer">
											</div>
										</div>
										<div class="col-md-3"></div>
									</div>
